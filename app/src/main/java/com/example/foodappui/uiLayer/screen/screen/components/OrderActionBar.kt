...
fun  OrderActionBar(
    ...
    Surface(
        ...
        color = FoodAppUiTheme.colors.surface,
        contentColor = FoodAppUiTheme.colors.onSurface,
...
@Composable
fun Cart(totalPrice: String, onClicked: () -> Unit, modifier: Modifier) {
    Surface(
    ...
    )
    {
     Row (
         ...
         Text(
             ...
             color = FoodAppUiTheme.colors.onSurface,
